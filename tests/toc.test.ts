...
describe("TOC rendering", () => {
  it("renders active and merged sections", () => {
    ...
    expect(toc).toContain('<th width="45"></th>');
    expect(toc).toContain('<th width="685">Title/Link</th>');
    expect(toc).toContain('<th width="45"></th>');
    ...
    expect(toc).toContain('<td width="685"><a href="https://example.test/10">A</a></td>');
  ...
  it("marks only the focused branch as active", () => {
    ...
    expect(toc).toContain('<td width="45"><img src="https://raw.githubusercontent.com/slavvvvvvv/git-stack/main/assets/icons/viewing-icon.svg"');
    expect(toc).not.toContain('<td width="685"><a href="https://example.test/10">A</a></td>\n      <td width="45"><img src="https://raw.githubusercontent.com/slavvvvvvv/git-stack/main/assets/icons/viewing-icon.svg"');
  });
});
